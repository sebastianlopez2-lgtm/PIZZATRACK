...
↩️  Pedido deshecho: Pizza: Hawaiana | Ingredientes: [Jamón, Piña, Queso]

Seleccione una opción: 3
↪️  Pedido rehecho: Pizza: Hawaiana | Ingredientes: [Jamón, Piña, Queso]
```

## Video de Sustentación
> 📹 [Enlace al video aquí — YouTube / Drive / GitHub]

---
*Desarrollado con Java | Estructuras de Datos — Pilas con Listas Ligadas*
